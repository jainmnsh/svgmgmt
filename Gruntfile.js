        ...
        ngdocs : {
            options: {
                ...
                scripts: [
                    ...
                    'app/lib/angular-google-maps/angular-google-maps.min.js',
                    'app/lib/pubnub/pubnub.min.js',
                    'app/lib/pubnub-crypto/pubnub-crypto.min.js',
                    'app/lib/pubnub-angular/pubnub-angular.js'
                ],
                html5Mode: false,
                startPage: '/api',
            ...
            api: {
                src: ['app/lib/pubnub/*.js','app/js/*.js', 'app/modules/**/*.js'],
                title: 'App Documentation'
            }
        },
...
//                        'app/js/pubnub/pubnub.min.js',
//                        'app/js/pubnub/pubnub-crypto.min.js',
//                        'app/js/pubnub/pubnub-angular.js',
                        'app/modules/*/*.js',
            ...
            dist: {
                files: {
                    src: [
                        ...
                        '<%= yeoman.dist %>/app/lib/underscore/underscore-min.js',
                        '<%= yeoman.dist %>/app/lib/angular-google-maps/angular-google-maps.min.js',
                        '<%= yeoman.dist %>/app/lib/pubnub/pubnub.min.js',
                        '<%= yeoman.dist %>/app/lib/pubnub-crypto/pubnub-crypto.min.js',
                        '<%= yeoman.dist %>/app/lib/pubnub-angular/pubnub-angular.js',
